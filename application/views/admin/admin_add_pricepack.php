               ...
               <div class="span12">
                  ...
                  <div class="portlet box green">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>Add Price Pack</h4>
                        
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       
          <form action="<?php echo base_url(); ?>admin/pricepack/insert_pricepack" id="insert_mediatype" method="post" class="form-horizontal" enctype="multipart/form-data">
                           ...
                           <div class="alert alert-success hide">
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
								 <input type="text" name="pack_name" data-required="1" class="span6 m-wrap"/>
							  </div>
                           </div>
                           <div class="control-group">
