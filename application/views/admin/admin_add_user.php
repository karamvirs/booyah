                ...
                <div class="span12">
                    <div class="portlet box green">								
                        ...
                        <div class="portlet-body form">							
						  <?php echo form_open('admin/users/add_user', array('class' => 'form-horizontal','id' => 'add_user','method'=>'post')); 	
								...
								<button data-dismiss="alert" class="close"></button>
                                    ...
                                    <div class="row-fluid">
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" class="m-wrap span12" name="name" placeholder="Enter User Name" value="<?php echo set_value('name'); ?>">                                                
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->                                       
									   ...
									   <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">                                                
                                                <label class="radio">
                                                <input type="radio" name="type" value="pro" <?php echo set_radio('type', 'pro'); ?> />
                                                Premium
                                                </label>
                                                <label class="radio">
                                                <input type="radio" name="type" value="regular" <?php echo set_radio('type', 'regular'); ?> />
                                                Regular
                                                </label>  
                                             </div>
                                          </div>
                                    ...
                                    <div class="row-fluid">
										<div class="span6 valid">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="email" name="email" class="m-wrap span12" placeholder="Enter User Email" value="<?php echo set_value('email'); ?>" >
                                             </div>
                                          </div>
                                       </div>	
									...
									<div class="row-fluid">
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="password" id="password" name="password" class="m-wrap span12" value="<?php echo set_value('password'); ?>"> 
									...
									<div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="password" class="m-wrap span12" name="repassword" value="<?php echo set_value('repassword'); ?>"> 
                                    ...
                                    <div class="row-fluid">
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" name="address1" class="m-wrap span12" value="<?php echo set_value('address1'); ?>"> 
									   ...
									   <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" class="m-wrap span12" name="address2" value="<?php echo set_value('address2'); ?>"> 
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" name="city" class="m-wrap span12" value="<?php echo set_value('city'); ?>"> 
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" name="province"  class="m-wrap span12" value="<?php echo set_value('province'); ?>"> 
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->
                                    ...
                                    <div class="row-fluid">
                                       <div class="span6 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input type="text" name="zip" class="m-wrap span12" value="<?php echo set_value('zip'); ?>"> 
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->
