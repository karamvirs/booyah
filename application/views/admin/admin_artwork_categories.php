		...
		<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url(); ?>admin/artwork_categories">All Artwork Categories</a>
								<i class="icon-angle-right"></i>
							</li>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>All ArtWork categories</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								</div>								<?php if($artwork_cat) { ?>
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									<thead>
										<tr>
											<th style="width:8px;"><input type="checkbox" class="group-checkable" data-set="#sample_1 .checkboxes" /></th>											<th class="hidden-480">Name</th>
									...
									<?php 
									$i=1;
										foreach($artwork_cat as $artwork_cat)
										{	
										?>
										<tr class="odd gradeX">
											<td><input type="checkbox" class="checkboxes" /></td>
											<td class="center" title="<?php  echo $artwork_cat['cat_id'] ?>"><?php  echo $artwork_cat['cat_name'] ?></td>											
											<th class="hidden-480"><a href="<?php echo base_url('admin/artwork_categories/edit/').'/'.$artwork_cat['cat_id'];?>">Edit</a> | 											<a onClick="return confirm('Do you want to delete the Category?');" href="<?php echo base_url('admin/artwork_categories/delete/').'/'.$artwork_cat['cat_id'];?>">Delete</a></th>
										</tr>
										<?php $i++;  }  ?>
