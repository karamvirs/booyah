	...
	<div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="<?php echo base_url(); ?>admin/addnetwork">Edit Deal</a>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box green">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                  <?php foreach($edit_deals as $edit_deal){	?>    
				  
          <form action="<?php echo base_url(); ?>admin/add_deals/edit_deals/<?php echo $edit_deal['deals_id'];?>" id="insert_mediatype" method="post" class="form-horizontal" enctype="multipart/form-data">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" name="name" data-required="1" class="span6 m-wrap" value="<?php  echo $edit_deal['name'] ?>"/>
                              </div>
                           </div>
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                                ...
                                <option value=""></option><?php echo ($edit_deal['media_id'] == "yes") ? 'selected="selected"' : ''; ?> 
                                <?php 
								$ar=json_decode($edit_deal['media_id']);
								foreach($all_medtpye as $allmediatype)
									{	
								?>
                                <option <?php echo (in_array($allmediatype['media_id'], $ar)) ? 'selected=""' : ''; ?> value="<?php echo $allmediatype['media_id']; ?>"><?php  echo $allmediatype['name'] ?></option>
								<?php
									}
								?>
						    ...
						    <div class="control-group">
                              ...
                              <div class="controls">
							   <?php 
								$arr=json_decode($edit_deal['category_id']);		
								foreach($all_artwork_cats as $all_artwork_cat)
								{	
								?>
                                    
                                 <label class="checkbox">
                                 <div class="checker" id="uniform-undefined"><span>
								 <input type="checkbox" <?php echo (in_array($all_artwork_cat['cat_id'], $arr)) ? 'checked="checked"' : ''; ?> value="<?php  echo $all_artwork_cat['cat_id']; ?>" name="categories[]" style="opacity: 0;"></span></div> <?php  echo $all_artwork_cat['cat_name'] ?>
                                 </label>
								 <?php
								}
								?>
						   ...
						   <?php 
											if($edit_deal['deals_images']!= "null") {
											$img=json_decode($edit_deal['deals_images']);
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
                                 <div data-provides="fileupload" class="fileupload fileupload-new">
                                    <div style="width: 200px; height: 150px;" class="fileupload-new thumbnail">
                                       <img alt="Photo" style="height:100%; width:100%" src="<?php echo base_url('templates/deals_images').'/'.$images;?>">
                                    </div>
                                    <div style="max-width: 200px; max-height: 150px; line-height: 20px;" class="fileupload-preview fileupload-exists thumbnail"></div>
                                    <div>
									   ...
									   <input type="hidden" name="deal_previous[]" value="<?php echo $images;?>"  class="default"></span>
                                       <a data-dismiss="fileupload" class="btn fileupload-exists" href="#">Remove</a>
                                    </div>
                                 </div>
