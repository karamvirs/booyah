               ...
               <div class="span12">
                  ...
                  <div class="portlet box green">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       <?php echo form_open('', array('class' => 'form-horizontal', 'id'=>'edit_artwork_category')); ?>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" name="cat_name" class="span6 m-wrap" value="<?php echo $cat_data[0]['cat_name']; ?>" required/>
                              </div>
                           </div>
...
<script>  
    jQuery(document).ready(function() {
        $("#edit_artwork_category").validate({
            rules: {
