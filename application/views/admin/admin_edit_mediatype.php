            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>admin/add_mediatype">Edit Mediatype</a>
                        </li>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>Edit MediaType</h4>

                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->

                            <form action="<?php echo base_url(); ?>admin/edit_mediatype/edit_media_type" id="insert_mediatype" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <?php
                                //foreach($edit_mediatype as $mediatype) { 
                                $mediatype = $edit_mediatype;
                                ?>
                                ...
                                <input type="hidden" name="media_id" value="<?php echo $mediatype['media_id'];  ?>">
                                <div class="control-group">
                                    <label class="control-label">Name:<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="name" class="span6 m-wrap" value="<?php echo $mediatype['name'];  ?>" required/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Width:<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="width" type="text" class="span6 m-wrap" value="<?php echo $mediatype['width']; ?>" required/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Height:<span class="required">*</label>
                                    <div class="controls">
                                        <input name="height" type="text" class="span6 m-wrap" value="<?php echo $mediatype['height']; ?>" required/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio">
                                            <div class="radio" id="uniform-undefined"><span>
                                                    <input type="radio" <?php echo ($mediatype['allow_deals'] == "yes") ? 'checked="checked"' : ''; ?> value="yes" name="allow_deals" style="opacity: 0;"></span></div>
                                            Yes
                                        </label>
                                        <label class="radio">
                                            <div class="radio" id="uniform-undefined"><span>
                                                    <input type="radio" <?php echo ($mediatype['allow_deals'] == "no") ? 'checked="checked"' : ''; ?> value="no" name="allow_deals" style="opacity: 0;"></span></div>
                                            No
                                        </label> 
                                    </div> 
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio">
                                            <div class="radio" id="uniform-undefined"><span>
                                                    <input type="radio" value="yes"  name="allow_image" <?php echo ($mediatype['custom_image'] == "yes") ? 'checked="checked"' : ''; ?> style="opacity: 0;"></span></div>
                                            Yes
                                        </label>
                                        <label class="radio">
                                            <div class="radio" id="uniform-undefined"><span>
                                                    <input type="radio" value="no" name="allow_image" <?php echo ($mediatype['custom_image'] == "no") ? 'checked="checked"' : ''; ?> style="opacity: 0;"></span></div>
                                            No
                                        </label>  
                                ...
                                <div class="control-group">
                                    <label class="control-label">Image Types <?php $ar = json_decode($mediatype['image_types']); ?></label>
                                    <div class="controls">
                                        <label class="checkbox">
                                            <div class="checker" id="uniform-undefined"><span>
                                                    <input type="checkbox" value="front" <?php echo (in_array("front", $ar)) ? 'checked="checked"' : ''; ?> name="image_types[]" style="opacity: 0;"></span></div> Front
                                        </label>
                                        <label class="checkbox">
                                            <div class="checker" id="uniform-undefined"><span>
                                                    <input type="checkbox" value="back" <?php echo (in_array("back", $ar)) ? 'checked="checked"' : ''; ?> name="image_types[]" style="opacity: 0;"></span></div> Back
                                        </label> 
                                        <label class="checkbox">
                                            <div class="checker" id="uniform-undefined"><span>
                                                    <input type="checkbox" value="deals" <?php echo (in_array("deals", $ar)) ? 'checked="checked"' : ''; ?> name="image_types[]" style="opacity: 0;"></span></div> Deals
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio">
                                            <div class="radio" id="uniform-undefined"><span>
                                                    <input type="radio" value="yes" name="allow_text_input" <?php echo ($mediatype['allow_text_input'] == "yes") ? 'checked="checked"' : ''; ?> style="opacity: 0;"></span></div>
                                            Yes
                                        </label>
                                        <label class="radio">
                                            <div class="radio" id="uniform-undefined"><span>
                                                    <input type="radio"  value="no" name="allow_text_input"  <?php echo ($mediatype['allow_text_input'] == "no") ? 'checked="checked"' : ''; ?> style="opacity: 0;"></span></div>
                                            No
                                        </label>  
                                    ...
                                    <div class="controls">
                                        <div data-provides="fileupload" class="fileupload fileupload-new">
                                            <div style="width: 200px; height: 150px;" class="fileupload-new thumbnail">
                                                <img alt="" src="<?php echo base_url('templates/mediatype_images') . "/" . $mediatype['image']; ?>">
                                            </div>
