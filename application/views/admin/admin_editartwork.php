	...
	<div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="<?php echo base_url(); ?>admin/addnetwork">Edit Artwork</a>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box green">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>Edit Artwork</h4>
                        
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
           <?php foreach( $edit_artwork as $artwork) { ?>    
          <form action="<?php echo base_url(); ?>admin/artwork/edit_artwork/<?php echo $artwork['artwork_id'];?>" id="edit_artwork" method="post" class="form-horizontal" enctype="multipart/form-data">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" name="name" data-required="1" class="span6 m-wrap" value="<?php echo $artwork['name'];  ?>"/>
                              </div>
                           </div>
						   <div class="control-group">
                     ...
                     <select data-placeholder="Choose media Types"  name="media_id[]" class="chosen span6" multiple="multiple" tabindex="6">
                                    <option value=""></option><?php echo ($artwork['media_id'] == "yes") ? 'selected="selected"' : ''; ?> 
                                <?php 
								$ar=json_decode($artwork['media_id']);
						   ...
						   <div class="control-group">
                              ...
                              <div class="controls">
							   <?php 
								$arr=json_decode($artwork['cat_id']);		
                              ...
                              <div class="controls">
                                 <div data-provides="fileupload" class="fileupload fileupload-new">
                                    <div style="width: 200px; height: 150px;" class="fileupload-new thumbnail">
                                       <img alt="" src="<?php echo base_url();?>templates/artwork_images/<?php echo $artwork['front_image'];  ?>">
                                    </div>
						  ...
						  <!-- <div class="control-group">
                              ...
                              <div class="controls">
                                 <div data-provides="fileupload" class="fileupload fileupload-new">
                                    <div style="width: 200px; height: 150px;" class="fileupload-new thumbnail">
                                       <img alt="" src="<!?php echo base_url();?>templates/artwork_images/<!?php echo $artwork['back_image'];  ?>">
                                    </div>
                                    <div style="max-width: 200px; max-height: 150px; line-height: 20px;" class="fileupload-preview fileupload-exists thumbnail"></div>
                                    <div>
                                       <span class="btn btn-file"><span class="fileupload-new">Select Image</span>
