                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>Edit Price Pack</h4>

                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->

                            <form action="<?php echo base_url(); ?>admin/pricepack/update_pricepack" id="insert_mediatype" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <label class="control-label">Pack Name:<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="pack_name" data-required="1" value="<?php echo $pricepacks['pack_name']; ?>" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Quantity</label>
                                    <div class="controls">
                                        <input type="text" name="quantity" data-required="1" value="<?php echo $pricepacks['quantity']; ?>"  class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Price:</label>
                                    <div class="controls">
                                        <input type="text" name="price" data-required="1" value="<?php echo $pricepacks['price']; ?>"  class="span6 m-wrap"/>
                                    </div>
                                </div>

                                <div class="form-actions">
                                    <input type="hidden" name="pricepack_id" value="<?php echo $pricepacks['pricepack_id']; ?>"/>
                                    <button type="submit" class="btn green">Submit</button>
                                    <button type="button" class="btn" type="cancel" onclick="window.location = '<?php echo base_url() ?>admin/pricepack'">Cancel</button>
