                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <h4><i class="icon-reorder"></i>Edit Delivery Zone</h4>

                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->

                            <form action="<?php echo base_url(); ?>admin/deliveryzone/update_zone" id="insert_mediatype" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="location_name" data-required="1" value="<?php echo $zone['location_name']; ?>" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Post Code</label>
                                    <div class="controls">
                                        <input type="text" name="post_code" data-required="1" value="<?php echo $zone['post_code']; ?>"  class="span6 m-wrap"/>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea  name="map" data-required="1"   class="span6 m-wrap"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="letter_boxes" data-required="1" value="<?php echo $zone['letter_boxes']; ?>"  class="span6 m-wrap"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <input type="hidden" name="delivery_zone_id" value="<?php echo $zone['delivery_zone_id']; ?>"/>
