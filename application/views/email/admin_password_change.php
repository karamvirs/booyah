...
<div style="width:700px; margin:0 auto;border-top: 0px solid #595959;">
	...
	<div style="float:left; width:100%; border-bottom:1px solid #595959;padding: 10px 0;">
        ...
        <div style="float:right; margin:70px 0 0 0;">PASSWORD CHANGE NOTIFICATION</div>
	</div>

	<div style="float:left; padding: 0 15px;line-height: 28px;">

		<p>Hi <?php echo $user_info['user_name']; ?>,</p>
		
		<p>Your 'Password' was changed and updated successfully!</p>
		<p>Your new password is <?php echo $changepassword;?>.</p>
