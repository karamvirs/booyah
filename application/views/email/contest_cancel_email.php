...
<div style="width:700px; margin:0 auto;border-top: 0px solid #595959;">
	...
	<div style="float:left; padding: 0 15px;line-height: 28px;">
		...
		<p>The contest you have entered above does not meet the minimum or maximum
requirement of participants.</p>
<p>We apologize for the inconvenience and have credited your account for the entry fee amount.</p>
	...
	<div style="float:left; width:100%;border-top:1px solid #595959;font-size:17px;  padding: 10px 0;">
		...
		<div style="float:right;margin-right: 10px;">&copy;<?php echo date("Y-m-d");?> Real Fantasy Wrestling.. All rights reserved</div>
