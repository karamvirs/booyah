                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        ...
                        <div class="portlet-body form1">
                            ...
                            <form action="<?php echo base_url();?>user/uploadgif" accept-charset="utf-8" enctype="multipart/form-data" 
							...
							<div class="row-fluid">
							   <div class="span10">
								  <div class="control-group">
									 <label class="control-label">Linkout</label>
									 <div class="controls">
										<input type="text" class="m-wrap span8" name="linkout" placeholder="Enter link" value="">                                                
									 </div>
								  </div>
							   </div>
							</div>
							<?php } ?>
                                    ...
                                    <div class="row-fluid">
										<div class="subcenter">
											...
											<input type="hidden" name="sumitted" value="sumitted">			
