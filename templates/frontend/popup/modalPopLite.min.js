(function(a) {
    ...
    a.fn.modalPopLite = function(c) {
        var c = a.extend({}, {openButton: "modalPopLite-open-btn", closeButton: "modalPopLite-close-btn", isModal: false, callBack: null}, c);
        return this.each(function() {
            ...
            a(triggerObj).live("click", function(b) {
                ...
                a("#modalPopLite-wrapper" + d).css({left: i + "px", top: j});
            ...
            a(window).resize(function() {
                if (e) {
                    ...
                    var h = b / 2 - f / 2;
                    var i = c / 2 - g / 2;
                    a("#modalPopLite-wrapper" + d).css({left: h + "px", top: i})
                }
            })
        })
    };
